...
<html>
    <head>
        <title>Nuova sessione di donazione</title>
        <meta name="author" content="Manolo Sainas">
        <meta name="description" content="La pagina dell'amministatore dove poter inserire una nuova donazione">
    ...
    <body>
        ...
        <c:if test="${not empty user}">        
            <h1>Inserisci una nuova sessione di donazione</h1>
        </c:if>
